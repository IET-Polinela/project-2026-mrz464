...
class AuthenticationTests(APITestCase):
    ...
    def test_AUTH_01_login_warga_dengan_kredensial_valid(self):
        ...
        # reverse() mengonversi nama URL menjadi path, avoiding hardcode URL
    ...
    def test_AUTH_03_warga_tidak_bisa_akses_halaman_admin(self):
        ...
        """
        # Login warga biasa via session authentication
        self.client.login(username='warga_test', password='Password123!')
        
        # Akses url /dashboard/ (atau reverse('dashboard:index'))
        # Karena warga biasa tidak memiliki is_staff atau is_admin, harus di-redirect ke halaman login (302)
